                ...
                <div class="row minimal-modern-charts">
                            ...
                            <div class="card-content pt-2 px-1">
                                <div class="row">
                                    <div class="col-8 d-flex">
                                        <div class="ml-1">
                                            <h4 class="power-consumption-stats-title text-bold-500">Power consumption
                                            </h4>
                                        </div>
                        ...
                        <div class="card chart-with-tabs">
                            <div class="card-content">
                                <ul class="nav nav-pills card-tabs mb-2 pl-2 border-bottom-blue-grey border-bottom-lighten-5"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-primary bg-transparent px-0 py-1"
                                        ...
                                        <div class="tracking-tab-container px-2">
                                            <div class="tracking-tab-content">
                                                <div
                                                    ...
                                                    <div class="pb-75">
                                                        <h5 class="tracking-tab-title mb-0 text-bold-600">Total Sales
                                                        </h5>
                                                ...
                                                <div class="bottom-content">
                                                    <ul class="tracking-list list-group">
                                                        ...
                                                        <li
                                                            class="list-group-item border py-1 px-0 d-flex justify-content-between align-items-center">
                                                            <span
                                                                class="tracking-task text-bold-600 text-left">Material
                                                                Admin</span>
                                                            <span
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-12 region-stats-chart">
                        <div class="card statistic-card">
                            <div class="card-content">
                                <div
                                    class="top-row statistics-card-title border-bottom-blue-grey border-bottom-lighten-5">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-25 latest-update-item-name text-bold-600">Total Revenue
                                                </p>
                                ...
                                <div class="row">
                                    <div class="col-12 pt-2 pb-2 border-bottom-blue-grey border-bottom-lighten-5">
                                        <div
                                            ...
                                            <h4 class="pl-2 mb-0 title-info-time-heading text-bold-500">Information
                                                Time Tracking</h4>
                                            <span class="pr-2">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <h5 class="font-weight-bold mt-2 mt-sm-0">General task
                                                                loading</h5>
                                                            <p class="leading-para">
                                                                The system automatically detects the loading of your
                                                                tasks. including sales and revenue.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <p class="leading-para">Your criticaly anylyzed success
                                                                data regarding revenue and sales for the
                                                                last week.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <ul>
                                            ...
                                            <li class="timeline-items timeline-icon-warning">
                                                ...
                                                <div class="timeline-title">
                                                    ...
                                                    <span
                                                        class="badge badge-pill badge-sm badge-success">Completed</span>
                                                </div>
                                            ...
                                            <li class="timeline-items timeline-icon-info">
                                                ...
                                                <div>
                                                    <ul
                                                        ...
                                                        <li class="avatar avatar-sm pull-up my-0">
                                                            <img class="rounded-circle"
                                                                src="../../../app-assets/images/portrait/small/avatar-s-21.png"
                                                                alt="Generic placeholder image"
                                                                data-toggle="tooltip" data-placement="top"
                                                                title="Stepan">
                                                        </li>
