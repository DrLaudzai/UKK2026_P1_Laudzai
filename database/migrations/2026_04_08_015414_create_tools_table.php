...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('tools', function (Blueprint $table) {
            ...
            $table->bigInteger('price')->nullable()->comment('Batas maks poin penalti user agar boleh meminjam alat ini. Contoh: nilai 3 = hanya user dengan penalty_points <= 3 yang bisa pinjam. NULL = semua user boleh pinjam');
            $table->integer('min_credit_scorebigint');
