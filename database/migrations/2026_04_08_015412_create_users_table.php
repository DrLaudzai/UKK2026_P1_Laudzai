...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('role', ["Admin","Petugas","Peminjam"])->comment('Role untuk menentukan akses  ,   admin bisa manage user dan alat, petugas bisa manage peminjaman dan pengembalian, peminjam hanya bisa pinjam alat');
